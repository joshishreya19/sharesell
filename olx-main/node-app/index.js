...
const mongoose = require('mongoose');
 ...
 mongoose.connect('mongodb+srv://srushtigade1207:1207@cluster0.dveqtlq.mongodb.net/')
//mongoose.connect('mongodb://localhost:27017/sharesellswap')
app.get('/', (req, res) => {
    res.send('Welcome to ShareSellSwap APP')
})
